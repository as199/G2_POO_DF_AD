<div class="container">
        <form method="post" action="<?= BASE_URL ?>/validerChambre" id="addsimples" enctype="multipart/form-data" class="bg-light mt-4">
                    <div class="form-row">

                        <div class="col-md-6">
                            <div class="form-group ml-5">
                                <label class="small mb-1 ml-2" for="inputFirstName">Numéro de Chambre</label>
                                <input class="form-control py-4" id="numero" name="numero" type="text" placeholder="Numéro de Chambre"  /></div>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col-md-6">
